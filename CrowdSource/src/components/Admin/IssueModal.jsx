...
const IssueModal = ({ issue, onClose, onForward, onChangePriority }) => {
  ...
  return (
    <div
      className="fixed inset-0 backdrop-blur-[1px] bg-opacity-50 flex items-center justify-center z-50 p-4"
      onClick={onClose}
    >
      <div
        className="bg-gray-100 rounded-lg max-w-3xl w-full max-h-full overflow-y-auto"
      ...
      >
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            <h3 className="text-lg font-medium text-gray-800 mb-2">
              {issue.department || "General"} Issue
            </h3>
          ...
          {issue.imgURL && (
            <div>
              <h4 className="font-medium text-gray-800 mb-2">Attached Image</h4>
              <img
                src={issue.imgURL}
                alt="Issue"
                className="rounded-lg max-h-72 w-full object-contain shadow-md"
              />
            </div>
          )}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-sm text-gray-600">{issue.department || "N/A"}</p>
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Priority
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              {issue.reportedBy?.name} - {issue.reportedBy?.phone}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <select
                disabled
                className="w-full px-3 py-2 border border-gray-300 text-black rounded-lg bg-gray-100 text-gray-400 cursor-not-allowed"
              >
        ...
        {/* Footer */}
        <div className="flex flex-wrap justify-end gap-3 p-6 border-t bg-gray-100">
          <button
            onClick={onClose}
